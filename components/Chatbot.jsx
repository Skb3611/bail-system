  ...
  const [messages, setMessages] = useState([
    {
      role: "model",
      parts:
        "Hello! I am your Indian Legal Assistant. I can help you understand IPC/CrPC sections, bail eligibility, and legal procedures. How can I assist you today?",
    },
  ]);
  ...
  if (!isOpen) {
    return (
      <Button
        ...
        className={cn(
          "fixed bottom-4 right-4 md:bottom-6 md:right-6 h-12 w-12 md:h-14 md:w-14 rounded-full shadow-xl bg-slate-900 hover:bg-slate-800 transition-all duration-300 z-30 animate-in fade-in zoom-in",
        )}
      >
              ...
              <div className="flex w-full flex-col gap-2">
                <div className="flex w-full items-center gap-2">
                  <Input
                    ...
                    className="flex-1 text-xs  md:text-sm focus-visible:ring-slate-900 border-slate-200"
                    disabled={isLoading}
                  />
                  <Button
                    size="icon"
                ...
                <p className="text-[10px] text-center text-slate-400">
                  AI responses are for informational purposes only and not legal
                  advice.
                </p>
              </div>
            </CardFooter>
